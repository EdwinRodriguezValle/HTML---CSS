...
<style>
  ...
  .container {
    ...
    /* Cambia solo el código debajo de esta línea */
grid-template-rows: 50px 50px /*para crear columanas*/
...
--------------------------------------------------------------------
Usa grid-column para controlar espaciado: LO que puedes hacer es ajustar una casa al ancho de las otras cajas o hacer que ocupen en espacio de las otras cajas.
...
/*El código anterior agrupa las celdas de la cuadrícula en cuatro áreas; header, advert, contenty footer. Cada palabra representa una celda y cada par de comillas representa una fila.
...
-------------------------
sa grid-area sin crear plantillas de área
